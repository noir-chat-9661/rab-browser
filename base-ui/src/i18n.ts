...
export const translations = {
  japanese: {
    ...
    history: "閲覧履歴",
    emptyHistory: "閲覧したページはここに表示されます。",
    openHistoryEntry: (title: string) => `${title}を新しいタブで開く`,
    navigate: "移動",
    newTabNavigate: "新しいタブを開く",
    searchWeb: "ウェブを検索",
    urlOrDomain: "URLまたはドメイン",
    openInCurrentTab: "現在のタブで開く",
    openInNewTab: "新しいタブで開く",
    findInPage: "ページ内検索",
    findPlaceholder: "ページ内を検索",
    findNext: "次の一致",
    findPrevious: "前の一致",
    closeFind: "ページ内検索を閉じる",
    findNoResults: "一致するテキストがありません",
  ...
  english: {
    ...
    history: "History",
    emptyHistory: "Pages you visit will appear here.",
    openHistoryEntry: (title: string) => `Open ${title} in a new tab`,
    navigate: "Navigate",
    newTabNavigate: "Open a new tab",
